...
class IdeaController extends Controller
{
    ...
    public function show(Idea $idea)
    {
        return view('idea.show', [
            ...
            'backUrl' => url()->previous() !== url()->full() // კონკრეტული იდეის ფეიჯიდან უკან როცა გადავდივართ მანადმე მონიშNული ფილტერები რომ შეინარჩუნოს ვატანთ პირობას რო წინა რექვესთის ლინკი თუ არ უდრის ახლანდელს დააბრუნოს წინა სხვა შემთხვევაში გადადის მტავარ გვერდზე
                ? url()->previous()
                : route('idea.index')
        ]);
    }
