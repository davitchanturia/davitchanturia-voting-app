...
class CategoryFiltersTest extends TestCase
{
    ...
    public function test_selecting_a_status_and_a_category_filters_correctly_together()
    {
        $user = User::factory()->create();
    ...
    public function test_category_query_string_filters_correctly_with_status_and_category_together()
    {
        $user = User::factory()->create();
