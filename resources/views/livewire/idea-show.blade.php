<div class="idea-and-butttons-container">
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            @if ($hasVoted)
                <button class="w-32 h-11 -mx-5 bg-blue border border-blue text-white font-bold text-xs uppercase rounded-xl
                    hover:border-blue hover:bg-blue-hover transition duration-150 ease-in px-4 py-3">
                    Voted
                </button>
            @else
                <button class="w-32 h-11 -mx-5 bg-gray-300 border border-gray-200 font-bold text-xs uppercase rounded-xl
                    hover:border-gray-400 transition duration-150 ease-in px-4 py-3">
                    Vote
                </button>
            @endif
