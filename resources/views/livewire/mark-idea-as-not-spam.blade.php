<div
    ...
    @custom-show-mark-nospam-modal.window="   {{-- ვიღებთ გამოგზავნილ ივენთს და ვცვლით მნიშვნელობას --}}
        show = true
    ...
    >
      ...
      <div
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <button wire:click="resetSpamCounter" x-ref="confirmButton" type="button" 
