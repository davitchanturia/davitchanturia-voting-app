...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-bodyColor text-gray-900 text-sm">
       ...
       <main class="container mx-auto max-w-custom flex" ">
            <div class="w-70 mr-5" >
                  add idea form. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe officiis est esse eaque, iste dignissimos aliquam cum id, at officia, pariatur provident molestiae maiores perspiciatis nostrum quibusdam earum nesciunt modi nihil reiciendis unde obcaecati quod veniam. Voluptate quod optio ipsum? 
            </div>
